...
![冲突报警](https://blog.zoomquiet.io/_images/ssl-gh-pages-alert-cname.png)


删除原先 `blog.zoomquiet.io` 定制域名后, gh-pages 状态恢复:

![暂时默认](https://blog.zoomquiet.io/_images/ssl-gh-pages-revert-domain.png)
...
![迁移费用](https://blog.zoomquiet.io/_images/ssl-domain-transfer-pay.png)

> 再同意...

![同意迁移](https://blog.zoomquiet.io/_images/ssl-domain-transfer.png)

- 而且人家立即有挽救邮件来问, 为毛走哪....

![邮件事务](https://blog.zoomquiet.io/_images/ssl-domain-transfer-flow.png)


> namecheap 中进行恢复

![旧解析](https://blog.zoomquiet.io/_images/ssl-domain-dnspod.png)

> 使用官方模板, 替代 `DNSPod` 代理的...

![解析模板](https://blog.zoomquiet.io/_images/ssl-domain-dns2namecheap.png)


![生效等待](https://blog.zoomquiet.io/_images/ssl-domain-waitting.png)

![迁移成功](https://blog.zoomquiet.io/_images/ssl-domain-in-namecheap.png)
...
![全部OK](https://blog.zoomquiet.io/_images/ssl-domain-ko.png)
...
![gh 正常](https://blog.zoomquiet.io/_images/ssl-gh-pages-ko.png)

> 此时 gi-pages 配置已经感知到一切良好


![证书有效](https://blog.zoomquiet.io/_images/ssl-chrome-info.png)

点击 chrom 域名前的小图标, 可以看到 SSL 已生效

![检验](https://blog.zoomquiet.io/_images/ssl-chrome-chk.png)


当然, 原先模板中一系列资源指向老 `http` 资源都无法使用了

![资源丢失](https://blog.zoomquiet.io/_images/ssl-res-load-err.png)
...
![CNAME 重建](https://blog.zoomquiet.io/_images/ssl-domain-cname-renew.png)

> 再重新编译->push->等待 gh-pages 完成发布

![等待部署](https://blog.zoomquiet.io/_images/gh-pages-waitting.png)

那个褐色小点, 变成绿色对勾, 就说明一切安好...


![WOLA](https://blog.zoomquiet.io/_images/ssl-all-ok.png)
...
![DNSPod 升级?](https://blog.zoomquiet.io/_images/SSL-dnspod-acord-error.png)

![DNSPod 冲突](https://blog.zoomquiet.io/_images/SSL-dnspod-cname-error.png)

> 不得以, 迁移回 neamcheap 来配置, 顺畅完成:

![neamcheap 可配](https://blog.zoomquiet.io/_images/SSL-namecheap-acords.png)
...
![gl 强制嗯哼](https://blog.zoomquiet.io/_images/SSL-gl-pages-ssl.png)

> 打开 HTTPS 开关

![gl 域名上证](https://blog.zoomquiet.io/_images/SSL-gl-pages-redomain.png)
...
![证件无效](https://blog.zoomquiet.io/_images/SSL-chrome-chk-CA-not.png)

然后可以看到:

![检验通过](https://blog.zoomquiet.io/_images/SSL-CAX3-ok.png)

接着...

![还未安全](https://blog.zoomquiet.io/_images/SSL-chrome-chk-CA-ok.png)

最后...

![部分安全](https://blog.zoomquiet.io/_images/SSL-chrome-chk-info.png)

这是因为有的图片/css/js 资源, 还是用 hhtp 引用的, 得升级:

![iPic](https://blog.zoomquiet.io/_images/ipic-http.png)

俺采购的工具, 才发现主要图床还是 http 的

追查文档:

![7牛有关页面](https://blog.zoomquiet.io/_images/SSL-7niu-cdn.png)

> 对比隔壁 ...

![UPYUN 有关页面](https://blog.zoomquiet.io/_images/SSL-upyun-https.png)
...
![一切安全](https://blog.zoomquiet.io/_images/SSL-chrome-chk-good.png)
...
![报警](https://blog.zoomquiet.io/_images/ssl-dnspod-err.png)
