这是大妈在 **ZoomQuiet** 的第**041**篇原创

# 蟒营®/ 到底改变了什么?+2
> 编程思维提高班Python版 课程效果

最近发现, 从课程角度来阐述基本没什么新内容了,
就发动过往优秀学员来回顾, 闯过 蟒营®课程后, 自己最最深刻的改变是什么?

自然就有了一个系列.

> 来自5py @qqzh

回想起在5py的一个多月,好多事还历历在目,

尤其是那种被任务带来的未知困难逼到焦虑头疼,最后在同学们和大妈的启发下找到答案的**豁然开朗**. 

这种从焦虑到无力再到最后放松的感觉跟坐过山车差不多吧 `哈哈哈`. 

怎么从频繁扑街到还能爬起来接着自虐虐他呢?
...
个人体会很深的一句话是某次在问题卡死想撂挑子的时候,
大妈曰:

    在Python的学习里,
    每一个问题至少都有三种解决方法. 

(这句话结合大妈发过一张关于解决问题思路的图理解更清楚,包括苍蝇式探索和分支式探索的对比)


![](http://ydlj.zoomquiet.top/ipic/2020-07-08-explor-diff.png)

以上大概就是个人体会最深的两点吧,总结一下:

- 一是在挫败感里挺住,坚持下去有勇气继续探索;
- 二是掌握探索的方法,包括准确的问题描述,搜索正确的参考资料,以及求助提问和迭代. 

另外坚持到后期进入团队合作阶段,除了编程思路之外还有很多别的点,

进入性别/性格/年龄/行业/...大融合的蟒营真的很有意思,
也会需要多元化的包容和磨合,这些技术点交流和合作的心态,
大家加入后自己慢慢体会吧,肯定比看文字隔靴搔痒有收获. 
