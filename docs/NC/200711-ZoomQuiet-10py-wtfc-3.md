这是大妈在 **ZoomQuiet** 的第**042**篇原创

# 蟒营®/ 到底改变了什么?+3
> 编程思维提高班Python版 课程效果


> 0py@xiaoyan:给大妈写的推荐序

作为蟒营的第 0 期优秀学员,我有如下感触想给大家分享:

首先自我介绍:

我是一个理科背景的的计量工程师,编程基础聊胜于无;我编写了一个用于校准工作中的软件并在实际工作中获得了应用,并申请了人生中第一个软件著作权. 所以我认为,自己算是会编程了. 然而,这些主要是从大妈的蟒营课程中学到的. 

大妈的编程教学方法和其他的课程非常的不同,可以大致以如下标签进行标识:
...
- 我坚持写编程学习探索日志,并且在首期学习中使用了在 Issue 中列出了 Flag 和监控列表的方法,这种方法相当于将自己想做的事给别人列出来看. 

这个方法有四个好处:

- 第一,公布自己的目标,展示给大家,给自己刨了个坑,可以驱动自己不停的去填坑---念念不忘,必有回响. 
- 第二,有个主线,能够及时归位,让自己不至于在浩渺的知识海洋中走失. 
- 第三,同侪压力. 小伙伴们都可以相互看到彼此在干什么,同侪压力的良性相互攀比会对自己造成巨大的驱动力. 自己写的东西会被小伙伴们参考并在周例会上讲出来,这种成就感和参与感非常的爆棚. 
- 第四,及时反馈. 我们写出来的东西和思考过程可以及时被"大妈们"看到,会被及时纠偏---"醒醒嗨,你走偏了";同学们之间可以互相对对方写的东西发表评论,这种及时反馈是符合认知心理学的规律的. 

最重要的收获:

习惯和节奏是最重要的. 无论是读书,写作,编程等需要长周期积累的事情,都需要在一个目标的驱动下,按照固定的时间和节奏进行,这样的阻力是最小的,成就是最大的. 日拱一卒的日常努力远比毕其功于一役的豪迈重要的多. 

蟒营的学习不仅仅是一个学习别人创造知识的过程,
更是一个自己参与**创造课程**的过程. 

我们在这里可以真切的体会到我们的存在感,体会到知识是如何创造的,这种将一个事物(软件)从无到有的创造出来的过程会给我们带来上帝**创世纪**的那种成就感. 
