...
这是大妈在 **ZoomQuiet** 的第**044**篇原创


> 2py@小米

蟒营的放养式教学刚开始真的有点让人不知所措,也不太能产生信任,毕竟谁网课是这么上的呀?
没有教学视频,没有各种 zip 包给你学习资源... 
但是每次发布的 task 文档里面都内容满满,**让人挠头**.  

突然接收到大量的文字信息,我变得非常没有耐心,在阅读的过程中不自觉的忽略了很多信息,甚至在第一个任务周,我把当周的任务都搞错了... 
非常经典的 **"视而不见"**,十分尴尬. 

从那以后,遇到海量信息再读不下去,也会硬着头皮看,渐渐的养成了逐字阅读的习惯,变得更有耐心去提取里面的信息,尽可能不犯**"视而不见"**的错误,或许避免尴尬也成了我的生产力吧.  

来到蟒营我也开始有解决问题的自信,遇到 bug 第一反应不再唉声叹气了,心里有很清晰的探索步骤

- 0x01 仔细阅读错误提示,先自己进行简单排查
- 0x02 查阅官方文档
- 0x03 Bing/Baidu,有条件的Google
- 0x04 ...
- 0x05 再重新梳理一遍问题,用文字描述出来
- 0x06 尝试3种以上的方法还是解决不了,求助他人 

其实,在 bug 的提示信息也是 非常有用的,有时候是很关键的解决问题的方向或者钥匙,不能忽略,

**(少犯视而不见的错误)**. 

现在,学会利用如何网络也成为了我的一种自信,毕竟坐拥这么丰富的网络资源. 
**"前人栽树,后人乘凉"**,或许在某个问题上我也会是栽树的前人.  
...
> 是也乎: 优秀的米队,现在就变成后来蟒营®学员的大师姐,从方法/态度上栽好了大树
